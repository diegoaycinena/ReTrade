...
set more off
capture log close
log using "$my_path\ReTrade\ReTrade2\Log\do-crReTrade2_Sim1.log", replace

/* ReTrade Project (Stage II - Simulations)*/
/* Re-Trading, Price Discovery and Efficiency under Alternative Exchange Institutions */
/* Generates SIMULATIONS action level (bids, asks, trades, etc.) database */ 
/* creates SimAction0.dta file */
/* by Diego Aycinena */
/* Created: 2017-06-07 */
...
compress
save $path_data\SimAction0, replace
capture drop bidqueue offerqueue trades tentativebids tentativeoffers openoffers
saveold $path_data\SimAction_old_11, version(11) replace
